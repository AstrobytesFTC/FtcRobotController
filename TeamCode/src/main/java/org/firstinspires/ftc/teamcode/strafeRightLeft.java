...
@TeleOp
public class strafeRightLeft extends LinearOpMode {
    ...
    public void encoderStrafe(double dx) {
        /* 1. Assign the motors
           ...
           6. End the function
       */
        double ticks = 1.1*(dx / CENTIMETERS_PER_TICK);
        ...
        double frontRightMotorTarget = frontRightMotorPos - ticks;
        double backRightMotorTarget = ticks + backRightMotorPos;
        double backLeftMotorTarget = backLeftMotorPos -ticks;
